...
{
    public abstract class BaseDialogLogic<TViewModel, TEntity, TSearchable> where TViewModel : class where TEntity : class, IEntity where TSearchable : class, ISearchable
    {
